                        ...
                        <td align="center">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="<?=\Libs\Helper::getUrl("cadastro","", $Item->EscolaId)?>"><i
                                                class="fa fa-edit"></i>
                                            Editar</a></li>
                                    <li><a onclick="Excluir(<?=@$Item->EscolaId;?>)"><i class="fa fa-trash-o"></i> Excluir</a></li></ul>
                            </div>
