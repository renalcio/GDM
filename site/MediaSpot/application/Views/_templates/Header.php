        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a href="../../index2.html" class="navbar-brand"><b>Media</b>Spot</a>
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <form class="navbar-form navbar-left" role="search" id="buscaForm" method="post" action="<?=\Libs\Helper::getUrl("Index",
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="BuscaQ" placeholder="Buscar Artistas ou Músicas" autocomplete="off" name="q">
                        </div>
                    </form>
