...
class Artist extends Media {
	 ...
	 * @throws	Error
	 */
	public static function getSimilar($artist, $mbid = null, $limit = null){
	 ...
	 * @throws	Error
	 */
	public static function getTopTracks($artist = null, $mbid = null, $limit = null, $page = 1){
	   $params = Array();
       if($artist!= null) $params['artist'] = $artist;
       if($mbid != null) $params['mbid'] = $mbid;
       
       if($limit!= null) $params['limit'] = $limit;
       $params['page'] = $page;
       
		$xml = CallerFactory::getDefaultCaller()->call('artist.getTopTracks', $params);
