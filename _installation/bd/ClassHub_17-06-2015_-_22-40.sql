...
--
-- Host: 127.0.0.1
-- Generation Time: 17-Jun-2015 às 22:40
...
INSERT INTO `Avaliacao` (`AvaliacaoId`, `MateriaId`, `TurmaId`, `Titulo`, `Data`, `DataCadastro`, `Peso`, `Descricao`, `Trabalho`, `EscolaId`, `CursoId`, `AlunoId`, `Compartilhado`) VALUES
(1, 2, 1, 'Prova 2', '20/06/2015', 0, 0, '', 0, 1, 1, 1, 0),
(2, 1, 1, 'Outro Autor', '30/08/2015', 0, 0, '', 1, 1, 1, 2, 0),
(4, 2, 1, 'Apresentação do Seminário', '17/06/2015', 0, 0, '', 1, 1, 1, 1, 1);
...
--
ALTER TABLE `Avaliacao`
  MODIFY `AvaliacaoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `Aviso`
--
ALTER TABLE `Aviso`
  MODIFY `AvisoId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
