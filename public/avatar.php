...
define('URL', URL_PROTOCOL . URL_DOMAIN . URL_SUB_FOLDER);
    ...
    class CropAvatar {
        ...
        function __construct($src, $data, $file) {
            $this -> srcDir = ROOT.$this->srcDir;
            $this -> dstDir = ROOT.$this->dstDir;
            $this -> urlBase = URL.$this->urlBase;
            $this -> setSrc($src);
            $this -> setData($data);
            $this -> setFile($file);
        ...
        private function setDst() {
            ...
            $this-> urlImg =  $this->urlBase. '/' . date('YmdHis') . $this -> extension;
        }
        ...
        public function getResult() {
            return !empty($this -> data) ? $this -> urlImg : $this -> urlImg;
        }
