...
(function (Ea, P, k) {
    var O = function (h) {
        ...
        function ob(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch, f = a.aanFeatures, g = '<div class="input-group"><input placeholder="Pesquisar" type="search" class="' + b.sFilterInput + '"/><span class="input-group-addon"><i class="fa fa-search"></i></span></div>', i = e.sSearch, i = i.match(/_INPUT_/) ? i.replace("_INPUT_", g) : i + g, b = h("<div/>", {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "<div class='input-group'><span class='input-group-addon'><i class='fa fa-filter'></i></span>_MENU_</div>",
