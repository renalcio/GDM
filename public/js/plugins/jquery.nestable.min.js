...
(function(e, g, h, c) {
	...
	var d = {
		...
		emptyClass: "dd-empty",
		expandBtnHTML: '<button data-action="expand" class="btn btn-sm" type="button"><i class="fa fa-plus"></i></button>',
		collapseBtnHTML: '<button data-action="collapse" class="btn btn-sm"  type="button"><i class="fa fa-minus"></i></button>',
		group: 0,
		maxDepth: 5,
		threshold: 20
	};
