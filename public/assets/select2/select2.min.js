...
(function (e, t) {
            ...
            r = window.setTimeout(function () {
                ...
                e.extend(c, {
                    url: s, dataType: n.dataType, data: r, success: function (e) {
                        ...
                        var r = {hasError: true, jqXHR: e, textStatus: t, errorThrown: n};
                        a.callback(r)
                    }
                });
                i = f.call(u, c)
    ...
    n = q(Object, {
        bind: function (e) {
            ...
            var e = this.opts.element, n = e.data("select2"), r = this;
            this.close();
            ...
            var n = this.opts.element, r, i = this;
            ...
            if (r !== t) {
                ...
                this.propertyObserver.observe(n.get(0), {attributes: true, subtree: false})
            }
        }, triggerSelect: function (t) {
            var n = e.Event("select2-selecting", {val: this.id(t), object: t, choice: t});
            ...
            var t = this.dropdown, n = this.container, r = n.offset(), i = n.outerHeight(false), s = n.outerWidth(false), o = t.outerHeight(false), u = e(window), a = u.width(), l = u.height(), c = u.scrollLeft() + a, h = u.scrollTop() + l, p = r.top + i, d = r.left, v = p + o <= h, m = r.top - o >= u.scrollTop(), g = t.outerWidth(false), y = function () {
                return d + g <= c
            }, b = function () {
                return r.left + c + n.outerWidth(false) > g
            }, w = t.hasClass("select2-drop-above"), E, S, x, T, N;
            if (w) {
                S = true;
                if (!m && v) {
                    x = true;
            ...
            var t = this.results, n, r, i, s, o, u, a, f;
            r = this.highlight();
            if (r < 0)return;
            if (r == 0) {
                t.scrollTop(0);
    ...
    r = q(n, {
        createContainer: function () {
            ...
            var t, n = this.container, r = this.dropdown, i = s(), o;
            if (this.opts.minimumResultsForSearch < 0) {
    ...
    e.fn.select2.locales["en"] = {
        formatMatches: function (e) {
            if (e === 1) {
                return "Um resultado está disponível, entre para selecioná-lo."
            }
            return e + " resultados disponíveis, use as setas para navegar."
            ...
            var n = t - e.length;
            return "Por favor digite " + n + " ou mais caractere" + (n == 1 ? "" : "s")
        }, formatInputTooLong: function (e, t) {
            var n = e.length - t;
            return "Por favor apaque " + n + " caractere" + (n == 1 ? "" : "s")
        }, formatSelectionTooBig: function (e) {
            return "Você só pode selecionar " + e + " ite" + (e == 1 ? "m" : "ns")
    ...
    window.Select2 = {
        ...
        "class": {"abstract": n, single: r, multi: i}
    }
})(jQuery)